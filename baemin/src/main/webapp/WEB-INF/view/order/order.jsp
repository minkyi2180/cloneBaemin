		...
		<li class="delivery_cont">
			...
			<div class="delivery_info">
				...
				<div>
					...
					<button type="button" onclick="modifyAddress()" id="delivery_modify" >주소 변경하기</button>
	             	<%@ include file="/WEB-INF/view/include/modifyAddress.jsp" %>
				</div>
				
				<input type="hidden" id="deliveryAddress1" value="${BMaddress.address1 }" name="deliveryAddress1"> 
				<input type="hidden" id="deliveryAddress2" value="${BMaddress.address2 }" name="deliveryAddress2"> 
				
				
				<div>상세 주소</div>
				<div class="input_area"><input type="text" id="deliveryAddress3" maxlength="100" value="${BMaddress3 }"  name="deliveryAddress3"> </div>
